...
add_getdomains() {
    ...
    if [ "$COUNTRY" == 'russia_inside' ]; then
        ...
        EOF_DOMAINS=DOMAINS=https://raw.githubusercontent.com/AnotherProksY/allow-domains/main/Russia/outside-dnsmasq-nfset.lst
    elif [ "$COUNTRY" == 'ukraine' ]; then
        EOF_DOMAINS=DOMAINS=https://raw.githubusercontent.com/AnotherProksY/allow-domains/main/Ukraine/inside-dnsmasq-nfset.lst
    fi
